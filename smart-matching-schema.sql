...
-- Database schema for the recommendation system
...
('Royal Vegas Casino', 'https://royalvegascasino.com', 'Premium online casino with extensive game library', 'casino', 'malta', 10.00, 96.50, 85, 90, '["live-dealer", "mobile-app", "vip-program"]', '{"age": "25-45", "income": "middle-high", "experience": "intermediate"}'),
('SportsBet Pro', 'https://sportsbetpro.com', 'Leading sportsbook with competitive odds', 'sportsbook', 'curacao', 5.00, 94.20, 92, 85, '["live-betting", "mobile-app", "cash-out"]', '{"age": "21-35", "income": "middle", "experience": "beginner"}'),
('PokerElite Network', 'https://pokerelite.com', 'Professional poker platform with tournaments', 'poker', 'uk', 20.00, 97.80, 78, 95, '["tournaments", "multi-table", "coaching"]', '{"age": "30-50", "income": "high", "experience": "advanced"}');
...
('CasinoAffiliates Pro', 'https://casinoaffiliatespro.com', 'Top-performing casino affiliate network', 45.00, 'casino', '["US", "CA", "UK", "AU"]', 88, 92, 85),
