  ...
  const sendMessage = async () => {
    ...
    try {
      ...
      const errorMessage = {
        id: messages.length + 2,
        type: 'ai',
        content: "I apologize, but I'm experiencing some technical difficulties. Please try again in a moment, or switch to basic mode if the issue persists.",
        timestamp: new Date(),
        enhanced: false
      };
            ...
            <div style={{
              ...
              <div style={{
                ...
                <div style={{
                  ...
                  borderTop: useEnhanced ? '2px solid white' : '2px solid #667eea',
                  borderRadius: '50%',
      ...
      <div style={{
        ...
        <div style={{
          ...
          <input
            ...
            onFocus={(e) => e.target.style.borderColor = useEnhanced ? '#48bb78' : '#667eea'}
          ...
          {[
            ...
            <button
              ...
              onMouseOver={(e) => {
                ...
                e.target.style.borderColor = useEnhanced ? '#38a169' : '#cbd5e0';
              }}
              onMouseOut={(e) => {
                e.target.style.background = useEnhanced ? '#f0fff4' : '#f1f5f9';
                e.target.style.borderColor = useEnhanced ? '#48bb78' : '#e2e8f0';
              }}
            >
              {suggestion}
            </button>
