...
export default function MasterpieceAIChatWidget() {
  ...
  const sendMessage = async () => {
    ...
    try {
      ...
      const errorMessage = {
        ...
        type: "ai",
        content:
          "I apologize for the technical difficulty. As an AI consultant, I recommend trying again in a moment or switching to a different AI mode. If the issue persists, the platform's fallback systems will ensure you still get helpful responses.",
        timestamp: new Date(),
        enhanced: false,
        aiPersona: "Dr_Alexandra_Sterling",
      };
  ...
  const getEndpointForMode = (mode) => {
    switch (mode) {
      case "masterpiece":
        return "/api/ai-chat-masterpiece";
      case "enhanced":
        return "/api/ai-chat-enhanced";
      case "basic":
        return "/api/ai-chat";
      default:
        return "/api/ai-chat-masterpiece";
  ...
  const getPersonaForMode = (mode) => {
    switch (mode) {
      case "masterpiece":
        return "Dr_Alexandra_Sterling";
      case "enhanced":
        return "Alexandra_Sterling";
      case "basic":
        return "AI_Assistant";
      default:
        return "Dr_Alexandra_Sterling";
  ...
  return (
    ...
    >
      ...
      <div
        style={{
          background:
            aiModes.find((mode) => mode.id === aiMode)?.color ||
        ...
        {showCapabilities && (
          ...
          >
            <div style={{ fontWeight: "bold", marginBottom: "8px" }}>
              🚀 {aiModes.find((mode) => mode.id === aiMode)?.name}{" "}
              Capabilities:
            </div>
            <div
              style={{
          ...
          <div style={{ textAlign: "left", marginBottom: "20px" }}>
            ...
            >
              ...
              >
                ...
                <span>
                  {aiMode === "masterpiece" &&
                    "Dr. Sterling is analyzing with advanced AI..."}
                  {aiMode === "enhanced" &&
                    "Alexandra is processing your query..."}
      ...
      >
        ...
        >
          {aiMode === "masterpiece" &&
            "🧠 Masterpiece Mode: PhD-level expertise with web research, SEO analysis, and advanced strategies"}
          {aiMode === "enhanced" &&
            "⚡ Enhanced Mode: Advanced AI with platform integration and specialized knowledge"}
          {aiMode === "basic" &&
            "💬 Basic Mode: Reliable responses with platform knowledge base"}
        </div>
      </div>
