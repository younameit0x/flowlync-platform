...
export default function DemoConvert() {
  ...
  return (
    <div style={{ padding: 32, fontFamily: 'Arial, sans-serif' }}>
      ...
      {status === 'success' && (
        <div style={{ marginTop: 16, padding: 12, background: '#d4edda', border: '1px solid #c3e6cb', borderRadius: 4, color: '#155724' }}>
          ✅ Conversion logged successfully!
        </div>
      )}
      {status === 'error' && (
        <div style={{ marginTop: 16, padding: 12, background: '#f8d7da', border: '1px solid #f5c6cb', borderRadius: 4, color: '#721c24' }}>
