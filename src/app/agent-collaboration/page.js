  ...
  const loadDashboardData = useCallback(async () => {
    ...
    try {
      ...
      const notesResponse = await fetch(
        `/api/agent-collaboration/notes?target=${agentName}`,
      );
      ...
      const tasksResponse = await fetch(
        "/api/agent-collaboration/tasks?status=open",
      );
      ...
      const commsResponse = await fetch(
        `/api/agent-collaboration/communications?agent=${agentName}&unread=true`,
      );
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-purple-900 via-blue-900 to-indigo-900 flex items-center justify-center">
        <div className="text-white text-xl">
          🤖 Loading Agent Collaboration Dashboard...
        </div>
      </div>
    );
  }
          ...
          <div className="flex items-center justify-between mb-6">
            <div>
              ...
              <p className="text-gray-600 text-lg">
                Multi-agent coordination and communication center
              </p>
            </div>
          ...
          <div className="grid md:grid-cols-4 gap-6">
            ...
            <div className="bg-purple-50 rounded-2xl p-4 text-center">
              <div className="text-2xl font-bold text-purple-600">
                {tasks.filter((t) => t.assigned_agent === agentName).length}
              </div>
          ...
          {activeTab === "overview" && (
            <div className="space-y-8">
              <div className="text-center">
                ...
                <p className="text-gray-600 text-lg">
                  Coordinate work, share insights, and collaborate efficiently
                </p>
              </div>
                          ...
                          <button
                            onClick={() =>
                              sendMessage(
                                task.created_by_agent,
                                "question",
                                `Question about: ${task.task_title}`,
                  ...
                  <div className="grid gap-4">
                    ...
                    >
                      ...
                      <div className="text-sm opacity-90">
                        Document findings or discoveries
                      </div>
                    </button>
                    ...
                    <button className="bg-purple-600 text-white p-4 rounded-2xl text-left hover:bg-purple-700 transition-colors">
                      ...
                      <div className="text-sm opacity-90">
                        Share designs or code snippets
                      </div>
                    </button>
                  ...
                  <div className="space-y-4">
                    <div className="flex items-start space-x-3">
                      ...
                      <div>
                        ...
                        <div className="text-sm text-gray-600">
                          Share insights, decisions, and findings to help other
                          agents
                        </div>
                      </div>
                    </div>
                    <div className="flex items-start space-x-3">
                      ...
                      <div>
                        ...
                        <div className="text-sm text-gray-600">
                          Tag notes and tasks for easy discovery and
                          organization
                        </div>
                      </div>
                    </div>
