...
export default function SmartMatchingLanding() {
  ...
  const FeatureCard = ({ icon, title, description, benefit }) => (
    ...
    onMouseOut={(e) => {
      ...
      <h3 style={{ color: '#2d3748', fontSize: '20px', marginBottom: '12px' }}>{title}</h3>
  ...
  const TestimonialCard = ({ name, role, company, quote }) => (
    <div style={{
      ...
      <div style={{ color: '#667eea', fontSize: '24px', marginBottom: '12px' }}>⭐⭐⭐⭐⭐</div>
      <p style={{ color: '#4a5568', fontStyle: 'italic', marginBottom: '16px' }}>
        "{quote}"
      </p>
      <div>
        <div style={{ fontWeight: 'bold', color: '#2d3748' }}>{name}</div>
        <div style={{ color: '#667eea', fontSize: '14px' }}>{role}, {company}</div>
      </div>
    </div>
  );
      ...
      <div style={{ maxWidth: '1200px', margin: '0 auto', padding: '0 32px' }}>
        ...
        <div style={{ textAlign: 'center', padding: '80px 0 60px 0' }}>
          ...
          <p style={{
            ...
            Stop wasting 8-12 hours/week on manual affiliate research.
            Our AI finds optimal casino-affiliate partnerships in seconds.
          </p>
          ...
          <div style={{ display: 'flex', justifyContent: 'center', gap: '40px', flexWrap: 'wrap', marginTop: '40px' }}>
            <div style={{ textAlign: 'center', color: 'white' }}>
              <div style={{ fontSize: '32px', fontWeight: 'bold', color: '#48bb78' }}>2s</div>
              <div style={{ fontSize: '14px', opacity: 0.9 }}>AI Analysis Time</div>
            </div>
            <div style={{ textAlign: 'center', color: 'white' }}>
              <div style={{ fontSize: '32px', fontWeight: 'bold', color: '#48bb78' }}>94%</div>
              <div style={{ fontSize: '14px', opacity: 0.9 }}>Avg Confidence Score</div>
            </div>
            <div style={{ textAlign: 'center', color: 'white' }}>
              <div style={{ fontSize: '32px', fontWeight: 'bold', color: '#48bb78' }}>10hrs</div>
              <div style={{ fontSize: '14px', opacity: 0.9 }}>Time Saved/Week</div>
            </div>
            <div style={{ textAlign: 'center', color: 'white' }}>
              <div style={{ fontSize: '32px', fontWeight: 'bold', color: '#48bb78' }}>45%</div>
              <div style={{ fontSize: '14px', opacity: 0.9 }}>Avg Commission Rate</div>
            </div>
          </div>
        </div>
        ...
        <div style={{ padding: '60px 0' }}>
          <div style={{ textAlign: 'center', marginBottom: '60px' }}>
            ...
            <p style={{ fontSize: '18px', color: 'rgba(255, 255, 255, 0.8)', maxWidth: '600px', margin: '0 auto' }}>
              Traditional affiliate research is broken. Our AI fixes it with intelligent, data-driven matching.
            </p>
          </div>
        ...
        {/* How It Works */}
        <div style={{ padding: '60px 0', background: 'rgba(255, 255, 255, 0.05)', borderRadius: '24px', margin: '60px 0' }}>
          <div style={{ textAlign: 'center', marginBottom: '60px' }}>
            <h2 style={{ fontSize: '36px', color: 'white', marginBottom: '16px' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '40px' }}>
            <div style={{ textAlign: 'center' }}>
              ...
              <h3 style={{ color: 'white', fontSize: '24px', marginBottom: '12px' }}>Set Preferences</h3>
              <p style={{ color: 'rgba(255, 255, 255, 0.8)' }}>
                Tell AI your preferred casino categories, budget range, and experience level
              </p>
            </div>
            ...
            <div style={{ textAlign: 'center' }}>
              ...
              <h3 style={{ color: 'white', fontSize: '24px', marginBottom: '12px' }}>AI Analysis</h3>
              <p style={{ color: 'rgba(255, 255, 255, 0.8)' }}>
                AI analyzes 500+ affiliate programs against your criteria in seconds
              </p>
            </div>
            ...
            <div style={{ textAlign: 'center' }}>
              ...
              <h3 style={{ color: 'white', fontSize: '24px', marginBottom: '12px' }}>Get Matches</h3>
              <p style={{ color: 'rgba(255, 255, 255, 0.8)' }}>
                Receive personalized recommendations with confidence scores and reasoning
              </p>
            </div>
          </div>
        </div>
        ...
        <div style={{ padding: '60px 0', background: 'rgba(255, 255, 255, 0.05)', borderRadius: '24px', margin: '60px 0' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '24px', maxWidth: '900px', margin: '0 auto' }}>
            <div style={{
              ...
              <h3 style={{ color: '#2d3748', fontSize: '24px', marginBottom: '16px' }}>Starter</h3>
              <div style={{ fontSize: '48px', fontWeight: 'bold', color: '#667eea', marginBottom: '16px' }}>
                Free
              </div>
              <ul style={{ textAlign: 'left', color: '#4a5568', marginBottom: '24px' }}>
            ...
            <div style={{
              ...
              <h3 style={{ color: '#2d3748', fontSize: '24px', marginBottom: '16px' }}>Professional</h3>
              <div style={{ fontSize: '48px', fontWeight: 'bold', color: '#667eea', marginBottom: '16px' }}>
                $49<span style={{ fontSize: '18px', color: '#4a5568' }}>/month</span>
              </div>
              <ul style={{ textAlign: 'left', color: '#4a5568', marginBottom: '24px' }}>
            ...
            <div style={{
              ...
              <h3 style={{ color: '#2d3748', fontSize: '24px', marginBottom: '16px' }}>Enterprise</h3>
              <div style={{ fontSize: '48px', fontWeight: 'bold', color: '#667eea', marginBottom: '16px' }}>
                $199<span style={{ fontSize: '18px', color: '#4a5568' }}>/month</span>
              </div>
              <ul style={{ textAlign: 'left', color: '#4a5568', marginBottom: '24px' }}>
        ...
        <div style={{
          ...
          <h2 style={{ fontSize: '36px', color: 'white', marginBottom: '24px' }}>
            Ready to Revolutionize Your Affiliate Strategy?
          </h2>
          <p style={{ fontSize: '18px', color: 'rgba(255, 255, 255, 0.8)', marginBottom: '40px' }}>
            Join the future of affiliate marketing. Start with our interactive demo or dive right into the full AI experience.
          </p>
          ...
          <p style={{ color: 'rgba(255, 255, 255, 0.6)', marginTop: '24px', fontSize: '14px' }}>
            ✅ No credit card required • 🚀 Setup in 2 minutes • 📈 See results immediately
          </p>
        </div>
        ...
        <footer style={{
          ...
          <p style={{ marginBottom: '16px' }}>
            © 2025 FlowLync Platform. Built for affiliate marketers who want to work smarter, not harder.
          </p>
          <div style={{ display: 'flex', justifyContent: 'center', gap: '24px', flexWrap: 'wrap' }}>
            ...
            <Link href="/support" style={{ color: 'rgba(255, 255, 255, 0.7)', textDecoration: 'none' }}>Support</Link>
          </div>
        </footer>
      </div>
    </div>
